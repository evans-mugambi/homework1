...
# Calculate the mean of yvals
yvm <- mean(df1$yvals)
# Difference between the first observation of yvals and yvm
 ymd <- df1$yvals[1] - yvm

# Difference between the first observation of fitted.values and yvm
 yfd <- model1$fitted.values[1] - yvm
# Compute the percentage of explained variation
yfd / ymd
```
...
```{r}
#| echo: fenced
#| eval: true  # Changed from false to true
